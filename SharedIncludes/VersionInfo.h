#ifndef SFH_VERSION_INFO_H
#define SFH_VERSION_INFO_H

#define SFH_VERSION_MAJOR 1
#define SFH_VERSION_MINOR 2
#define SFH_VERSION_PATCH 5
#define SFH_VERSION_BUILD 0

#define SFH_VERSION_NUMERIC 1,2,5,0
#define SFH_VERSION_STRING "1.2.5"
